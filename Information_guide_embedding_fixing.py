...
class DocxVectorizerOpenAIPinecone:
    ...
    def embed_and_store_docx(self, file_path: str, information_name: str, replace_existing: bool = True):
        """
    ...
    def query_similar(self, query_text: str, top_k: int = 5, information_name: str = None):
        ...
        filter_dict = {}
        if information_name:
            filter_dict["information_name"] = {"$eq": information_name}
    ...
    def process_specific_docx(self, filename: str, information_name: str, replace_existing: bool = True):
        """
        ...
        if os.path.exists(file_path):
            ...
            self.embed_and_store_docx(file_path, information_name=information_name, replace_existing=replace_existing)
        else:
...
if __name__ == "__main__":
    ...
    vectorizer.process_specific_docx(
        "BRINDY NOTES - Navajo Flats.docx",  # Make sure this is a .docx file
        information_name="BRINDY NOTES - Navajo Flats",
        replace_existing=True
    )
    
    # Get statistics about the processed document
    vectorizer.get_document_stats("BRINDY NOTES - Navajo Flats")
